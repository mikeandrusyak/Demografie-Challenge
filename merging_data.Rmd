...
vatriables_zp <- readRDS(paste0(path_save,"vatriables_zp.rds"))
...
merging <- function(start_year, end_year, file_type, variables){
  ...
  write.csv(merged_data, paste0("questions_answers/nationality_econ_status/", file_type, "merged_data",".csv"), row.names = FALSE)
...
```{r}
hh_data_list <- merging(2010, 2021, "zp_", c("HOUSEHOLDYEARLYID", vatriables_zp))
```
