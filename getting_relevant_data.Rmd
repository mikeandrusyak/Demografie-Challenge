...
```{r}
variables_zp <- c("HOUSEHOLDYEARLYID", "SECCITIZ", "SECCITIZENSHIP","AGE", "IN_EDUCATION",
                  "MAINRESIDENCECATEGORY","NATIONALITYCAT", "NATIONALITYCONTI")
variables_hh <- c("HOUSEHOLDYEARLYID", "TYPEOFOWNERSHIP","SIZEOFPRIVATEHOUSEHOLD")
...
```
```{r}
result_df %>% filter(`do-d-40-se_user-syn-2019.xlsx` == 0) %>% rownames(.)
```
